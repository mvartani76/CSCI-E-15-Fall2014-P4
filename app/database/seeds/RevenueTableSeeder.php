...
class RevenueTableSeeder extends Seeder {
	public function run() {
		...
		$revenue1->revenue_description = 'Project 1 Revenues from HW products';
		$revenue1->amount = 20000;
		$revenue1->year = 2014;
		$revenue1->save();

		$revenue2 = new Revenue();
		$revenue2->revenue_description = 'Project 1 Revenues from SW products';
		$revenue2->amount = 20000;
		$revenue2->year = 2014;
		$revenue2->save();

		$revenue3 = new Revenue();
		$revenue3->revenue_description = 'Project 1 Revenues from Licensing';
		$revenue3->amount = 20000;
		$revenue3->year = 2014;
		$revenue3->save();

		$revenue4 = new Revenue();
		$revenue4->revenue_description = 'Project 1 Revenues from Royalties';
		$revenue4->amount = 20000;
		$revenue4->year = 2014;
		$revenue4->save();

		$revenue5 = new Revenue();
		$revenue5->revenue_description = 'Project 1 Non operating income from interest';
		$revenue5->amount = 20000;
		$revenue5->year = 2014;
		$revenue5->save();

	    $revenue6 = new Revenue();
		$revenue6->revenue_description = 'Project 1 Revenues from HW products';
		$revenue6->amount = 30000;
		$revenue6->year = 2015;
		$revenue6->save();

		$revenue7 = new Revenue();
		$revenue7->revenue_description = 'Project 1 Revenues from SW products';
		$revenue7->amount = 30000;
		$revenue7->year = 2015;
		$revenue7->save();

		$revenue8 = new Revenue();
		$revenue8->revenue_description = 'Project 1 Revenues from Licensing';
		$revenue8->amount = 30000;
		$revenue8->year = 2015;
		$revenue8->save();

		$revenue9 = new Revenue();
		$revenue9->revenue_description = 'Project 1 Revenues from Royalties';
		$revenue9->amount = 30000;
		$revenue9->year = 2015;
		$revenue9->save();

		$revenue10 = new Revenue();
		$revenue10->revenue_description = 'Project 1 Non operating income from interest';
		$revenue10->amount = 30000;
		$revenue10->year = 2015;
		$revenue10->save();

	    $revenue11 = new Revenue();
		$revenue11->revenue_description = 'Project 1 Revenues from HW products';
		$revenue11->amount = 40000;
		$revenue11->year = 2016;
		$revenue11->save();

		$revenue12 = new Revenue();
		$revenue12->revenue_description = 'Project 1 Revenues from SW products';
		$revenue12->amount = 40000;
		$revenue12->year = 2016;
		$revenue12->save();

		$revenue13 = new Revenue();
		$revenue13->revenue_description = 'Project 1 Revenues from Licensing';
		$revenue13->amount = 40000;
		$revenue13->year = 2016;
		$revenue13->save();

		$revenue14 = new Revenue();
		$revenue14->revenue_description = 'Project 1 Revenues from Royalties';
		$revenue14->amount = 40000;
		$revenue14->year = 2016;
		$revenue14->save();

		$revenue15 = new Revenue();
		$revenue15->revenue_description = 'Project 1 Non operating income from interest';
		$revenue15->amount = 40000;
		$revenue15->year = 2016;
		$revenue15->save();

	    $revenue16 = new Revenue();
		$revenue16->revenue_description = 'Project 1 Revenues from HW products';
		$revenue16->amount = 50000;
		$revenue16->year = 2017;
		$revenue16->save();

		$revenue17 = new Revenue();
		$revenue17->revenue_description = 'Project 1 Revenues from SW products';
		$revenue17->amount = 50000;
		$revenue17->year = 2017;
		$revenue17->save();

		$revenue18 = new Revenue();
		$revenue18->revenue_description = 'Project 1 Revenues from Licensing';
		$revenue18->amount = 50000;
		$revenue18->year = 2017;
		$revenue18->save();

		$revenue19 = new Revenue();
		$revenue19->revenue_description = 'Project 1 Revenues from Royalties';
		$revenue19->amount = 50000;
		$revenue19->year = 2017;
		$revenue19->save();

		$revenue20 = new Revenue();
		$revenue20->revenue_description = 'Project 1 Non operating income from interest';
		$revenue20->amount = 50000;
		$revenue20->year = 2017;
		$revenue20->save();

	    $revenue21 = new Revenue();
		$revenue21->revenue_description = 'Project 1 Revenues from HW products';
		$revenue21->amount = 60000;
		$revenue21->year = 2018;
		$revenue21->save();

		$revenue22 = new Revenue();
		$revenue22->revenue_description = 'Project 1 Revenues from SW products';
		$revenue22->amount = 60000;
		$revenue22->year = 2018;
		$revenue22->save();

		$revenue23 = new Revenue();
		$revenue23->revenue_description = 'Project 1 Revenues from Licensing';
		$revenue23->amount = 60000;
		$revenue23->year = 2018;
		$revenue23->save();

		$revenue24 = new Revenue();
		$revenue24->revenue_description = 'Project 1 Revenues from Royalties';
		$revenue24->amount = 60000;
		$revenue24->year = 2018;
		$revenue24->save();

		$revenue25 = new Revenue();
		$revenue25->revenue_description = 'Project 1 Non operating income from interest';
